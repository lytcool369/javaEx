...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("Size: " + v.size() + ", 버퍼 공간: " + v.capacity());		// 버퍼 자동 증가
		...
		// 객체의 검색: indexOf()
		System.out.println("객체(7) 객체의 인덱스: " + v.indexOf(7));
		...
		// 객체 삭제: remove
		v.remove(10);		// 객체 10 삭제
		System.out.println("객체(10) 삭제: " + v);
		
		// 루프
		for (int i = 0; i < v.size(); i++) {
			Integer item = v.elementAt(i);
			System.out.printf("%d번 요소 %d%n", i, item);
		}
