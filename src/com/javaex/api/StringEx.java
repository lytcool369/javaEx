...
//		usefulMethods();
	...
	private static void usefulMethods() {
		...
		index = str.indexOf("Java", 4);				// 두 번째 검색 ("찾을 특정 문자", "시작할 위치")
		...
		if (index != -1) {
			...
			System.out.println(str.substring(index, index + 16));
		}
		
		System.out.println(str.substring(16));	// 인덱스 16부터 끝까지 추출
