...
public class TypesEx {
	...
	public static void integerTypesEx() {
		...
		int intVal;		// 선언, 1byte
		intVal = 2020;	// 할당(초기화)
//		int intVal2 = 1234567890234;	// 범위 초과
		
		long longVal1;	// 8byte
		long longVal2;
		
		longVal1 = 2020;
		longVal2 = 1234567890123L;		// 큰 자료일경우, 뒤에 L
		...
		System.out.println("0b1100 -> 2진수(0b) = " + bin);
		System.out.println("072 -> 8진수(0) = " + oct);
		System.out.println("0xFF -> 16진수(0x) = " + hex);
	}
	...
	public static void charEx() {
		...
		System.out.println(ch1 + ch2);	// int형으로 변환 후 합산이 되어버림
	...
	public static void constantEx() {
		...
		final int SPEED_LIMIT = 110;	// 단어의 조합은 _로 연결
